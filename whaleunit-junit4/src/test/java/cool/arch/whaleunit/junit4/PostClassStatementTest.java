...
import cool.arch.whaleunit.junit4.PostClassStatement;
import cool.arch.whaleunit.runtime.WhaleUnitRuntime;

/**
 * 
 */
public class PostClassStatementTest {

	private PostClassStatement specimen;
	...
	public void setUp() throws Exception {
		...
		specimen = new PostClassStatement(mockChildStatement, mockRuntime);

	}

	/**
	 * Test method for {@link cool.arch.whaleunit.junit4.PostClassStatement#evaluate()}.
	 * @throws Throwable 
	 */
	@Test
