...
import cool.arch.whaleunit.junit4.PreClassStatement;
import cool.arch.whaleunit.runtime.WhaleUnitRuntime;

/**
 * 
 */
public class PreClassStatementTest {

	private PreClassStatement specimen;
	...
	public void setUp() throws Exception {
		...
		specimen = new PreClassStatement(mockChildStatement, mockWhaleUnitRuntime, PreClassStatementTest.class);
	}

	/**
	 * Test method for {@link cool.arch.whaleunit.junit4.PreClassStatement#evaluate()}.
	 * @throws Throwable 
	 */
	@Test
