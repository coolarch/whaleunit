 ...
 * 
 */
public class PostMethodStatementTest {

	private PostMethodStatement specimen;
	...
	public void setUp() throws Exception {
		...
		mockMethod = PostMethodStatementTest.class.getMethod("testEvaluate");
		specimen = new PostMethodStatement(mockChildStatement, mockMethod, mockRuntime);
	}

	/**
	 * Test method for {@link cool.arch.whaleunit.junit4.PreMethodStatement#evaluate()}.
	 * @throws Throwable 
	 */
	@Test
