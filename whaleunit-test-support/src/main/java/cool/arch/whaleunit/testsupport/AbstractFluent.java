...
/*
 * #%L WhaleUnit - Test Support %% Copyright (C) 2015 CoolArch %% Licensed to the Apache
...
public abstract class AbstractFluent<G extends AbstractGivens<W, T>, W extends AbstractWhens<T>, T extends AbstractThens<T>>
	implements AbstractGivens<W, T>, AbstractWhens<T>, AbstractThens<T> {
