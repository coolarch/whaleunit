 ...
 * 
 */
public class DnsesTest {

	/**
	 * Test method for {@link cool.arch.whaleunit.api.model.Dnss#builder()} for single dns.
	 */
	@Test
	public final void testBuilderWithDns() {
	...
	/**
	 * Test method for {@link cool.arch.whaleunit.api.model.Dnss#builder()} for iterable of dns.
	 */
	@Test
	public final void testBuilderWithIterable() {
		final Dns dns = new Dns();

		final List<Dns> dnss = new ArrayList<>();
		dnss.add(dns);
