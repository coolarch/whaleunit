...
public final class VolumesFroms extends AbstractIterableGroup<VolumesFrom> {

	private VolumesFroms() {
	}

	public static GroupBuilder<VolumesFroms, VolumesFrom> builder() {
		return new GroupBuilderImpl<>(new VolumesFroms());
	}
}
