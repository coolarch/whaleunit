...
public final class Tuples {
	...
	public static <V0> Tuple1<V0> of(final V0 v0) {
		return new StrictTuple1Impl<>(v0);
	}

	public static <V0, V1> Tuple2<V0, V1> of(final V0 v0, final V1 v1) {
		return new StrictTuple2Impl<>(v0, v1);
	}
}
