...
public final class StateMachine<S extends Enum<S> & State<S, A, C>, A extends Enum<A>, C> {
	...
	public static <S extends Enum<S> & State<S, A, C>, A extends Enum<A>, C> StateMachine<S, A, C> create(
		final Class<S> statesType, final Supplier<Tuple2<S, C>> contextFactory) {
